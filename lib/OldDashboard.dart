...
class _OldDashboardState extends ResumableState<OldDashboard> {
 var claims;
                          ...
                          children: <Widget>[
                            ...
                            Container(
                              ...
                              child: Center(
                                child: Container(
                                  //margin: EdgeInsets.only(left: 10,top: 5),
                                  child: Text(requestCount!=null&&requestCount['Samples Scheduled']!=null?requestCount['Samples Scheduled'].toString():"0",
