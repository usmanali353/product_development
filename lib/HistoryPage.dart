       ...
       child: Container(
         ...
         child: ListView.builder(
           ...
           itemBuilder: (context, index) {
             return InkWell(
               onTap: (){
                 showRemarksDialog(context,remarksHistory[index]);
               },
               child: Card(
                 elevation: 5,
                 child: Container(
...
//                              ),
  ...
  showRemarksDialog(BuildContext context,RemarksHistory remarksHistory) {
    ...
    AlertDialog alert = AlertDialog(
      title: Text("Remarks"),
      content: Text(remarksHistory!=null&&remarksHistory.remarks!=null?remarksHistory.remarks:""),
      actions: [
        okButton,
      ],
    );
